...
export default function Footer() {
  return (
    <footer className="border-t border-slate-200 dark:border-slate-800 mt-16 no-print">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6 mb-8">
          ...
          <div>
            <Link href="/" className="inline-flex items-center gap-2.5 mb-2">
              <span className="w-8 h-8 rounded-lg bg-cyan-500/10 border border-cyan-500/20 flex items-center justify-center text-xs font-bold text-cyan-600 dark:text-cyan-400">
                CM
              </span>
        ...
        {/* Bottom row */}
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-6 border-t border-slate-100 dark:border-slate-800/80">
          ...
          <p className="text-xs text-slate-400 dark:text-slate-600">
            &copy; {new Date().getFullYear()} Cameron Mordoff
          </p>
        </div>
